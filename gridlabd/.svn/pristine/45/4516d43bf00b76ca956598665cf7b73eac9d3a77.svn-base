...
EXPORT CLASS *init(CALLBACKS *fntable, void *module, int argc, char *argv[])
{
	...
	if(gl_publish_variable(recorder_class,
		PT_double, "interval[s]", ((char*)&(rec->dInterval) - (char *)rec),
		PT_enumeration, "output", ((char*)&(rec->output) - (char *)rec),
			...
			PT_KEYWORD, "PNG",    PNG,
			PT_KEYWORD, "SVG",    SVG, 
		PT_enumeration, "header_units", ((char*)&(rec->header_units) - (char *)rec),
			PT_KEYWORD, "DEFAULT", HU_DEFAULT,
			PT_KEYWORD, "ALL", HU_ALL,
			PT_KEYWORD, "NONE", HU_NONE,
		PT_enumeration, "line_units", ((char*)&(rec->line_units) - (char *)rec),
	...
	if(gl_publish_variable(multi_recorder_class,
		PT_double, "interval[s]", ((char*)&(rec->dInterval) - (char *)rec),
		PT_char1024, "property", ((char*)&(rec->property) - (char *)rec),
		PT_char32, "trigger", ((char*)&(rec->trigger) - (char *)rec),
		PT_char1024, "file", ((char*)&(rec->file) - (char *)rec),
		PT_char1024, "multifile", ((char*)&(rec->multifile) - (char *)rec),
		PT_int32, "limit", ((char*)&(rec->limit) - (char *)rec),
		PT_char1024, "plotcommands", ((char*)&(rec->plotcommands) - (char *)rec),
		PT_char32, "xdata", ((char*)&(rec->xdata) - (char *)rec),
		PT_char32, "columns", ((char*)&(rec->columns) - (char *)rec),
		PT_enumeration, "output", ((char*)&(rec->output) - (char *)rec),
			PT_KEYWORD, "SCREEN", SCREEN,
			PT_KEYWORD, "EPS",    EPS,
			PT_KEYWORD, "GIF",    GIF,
	...
	if(gl_publish_variable(collector_class,
		PT_double, "interval[s]", ((char*)&(col->dInterval) - (char *)col),
			NULL) < 1)
