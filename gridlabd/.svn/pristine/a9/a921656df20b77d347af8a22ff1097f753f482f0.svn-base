...
OutputBaseFilename=gridlabd-2.3.1
AppName=GridLAB-D
AppVerName=GridLAB-D 2.3.1
; --RELEASE--
...
Source: "..\..\..\third_party\x86_64-w64-mingw32-gcc-4.7.2-release-win64_rubenvb.7z"; DestDir: "{app}"; Flags: deleteafterinstall
...
begin
  ...
  Path := ExpandConstant('{app}\mingw64\bin');
  if RegQueryStringValue(RootKey, SubKey, 'PATH', Value) then
  begin
    if Pos(Uppercase(Path + ';'), Uppercase(Value + ';')) <> 0 then
      exit;
...
Filename: "{app}\7za.exe"; Parameters: "x x86_64-w64-mingw32-gcc-4.7.2-release-win64_rubenvb.7z"; WorkingDir: "{app}"; Components: Compilers
Filename: "{app}\7za.exe"; Parameters: "x gnuplot-win32-4_2_3.zip"; WorkingDir: "c:\"; Components: Climate_Data\US
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip AK.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Other\AK
Filename: "{app}\7za.exe"; Parameters: "e AK.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Other\AK
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip PA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\PA
Filename: "{app}\7za.exe"; Parameters: "e PA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\PA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip CN.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\CN
Filename: "{app}\7za.exe"; Parameters: "e CN.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\CN
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip IA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\IA
Filename: "{app}\7za.exe"; Parameters: "e IA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\IA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip ID.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\ID
Filename: "{app}\7za.exe"; Parameters: "e ID.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\ID
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip IL.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\IL
Filename: "{app}\7za.exe"; Parameters: "e IL.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\IL
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip IN.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\IN
Filename: "{app}\7za.exe"; Parameters: "e IN.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\IN
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip MA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\MA
Filename: "{app}\7za.exe"; Parameters: "e MA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\MA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip ME.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\ME
Filename: "{app}\7za.exe"; Parameters: "e ME.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\ME
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip MI.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\MI
Filename: "{app}\7za.exe"; Parameters: "e MI.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\MI
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip MN.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\MN
Filename: "{app}\7za.exe"; Parameters: "e MN.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\MN
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip MT.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\MT
Filename: "{app}\7za.exe"; Parameters: "e MT.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\MT
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip ND.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\ND
Filename: "{app}\7za.exe"; Parameters: "e ND.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\ND
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip NE.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\NE
Filename: "{app}\7za.exe"; Parameters: "e NE.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\NE
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip NH.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\NH
Filename: "{app}\7za.exe"; Parameters: "e NH.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\NH
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip NJ.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\NJ
Filename: "{app}\7za.exe"; Parameters: "e NJ.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\NJ
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip NY.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\NY
Filename: "{app}\7za.exe"; Parameters: "e NY.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\NY
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip OH.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\OH
Filename: "{app}\7za.exe"; Parameters: "e OH.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\OH
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip PA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\PA
Filename: "{app}\7za.exe"; Parameters: "e PA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\PA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip RI.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\RI
Filename: "{app}\7za.exe"; Parameters: "e RI.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\RI
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip SD.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\SD
Filename: "{app}\7za.exe"; Parameters: "e SD.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\SD
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip VT.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\VT
Filename: "{app}\7za.exe"; Parameters: "e VT.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\VT
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip WI.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\WI
Filename: "{app}\7za.exe"; Parameters: "e WI.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\WI
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip WY.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\WY
Filename: "{app}\7za.exe"; Parameters: "e WY.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\North\WY
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip AR.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\AR
Filename: "{app}\7za.exe"; Parameters: "e AR.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\AR
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip DE.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\DE
Filename: "{app}\7za.exe"; Parameters: "e DE.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\DE
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip KS.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\KS
Filename: "{app}\7za.exe"; Parameters: "e KS.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\KS
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip KY.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\KY
Filename: "{app}\7za.exe"; Parameters: "e KY.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\KY
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip MD.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\MD
Filename: "{app}\7za.exe"; Parameters: "e MD.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\MD
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip MO.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\MO
Filename: "{app}\7za.exe"; Parameters: "e MO.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\MO
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip NC.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\NC
Filename: "{app}\7za.exe"; Parameters: "e NC.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\NC
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip OK.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\OK
Filename: "{app}\7za.exe"; Parameters: "e OK.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\OK
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip SC.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\SC
Filename: "{app}\7za.exe"; Parameters: "e SC.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\SC
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip TN.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\TN
Filename: "{app}\7za.exe"; Parameters: "e TN.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\TN
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip VA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\VA
Filename: "{app}\7za.exe"; Parameters: "e VA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\VA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip WV.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\WV
Filename: "{app}\7za.exe"; Parameters: "e WV.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Central\WV
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip AL.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\AL
Filename: "{app}\7za.exe"; Parameters: "e AL.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\AL
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip FL.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\FL
Filename: "{app}\7za.exe"; Parameters: "e FL.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\FL
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip GA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\GA
Filename: "{app}\7za.exe"; Parameters: "e GA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\GA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip LA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\LA
Filename: "{app}\7za.exe"; Parameters: "e LA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\LA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip MS.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\MS
Filename: "{app}\7za.exe"; Parameters: "e MS.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\MS
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip TX.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\TX
Filename: "{app}\7za.exe"; Parameters: "e TX.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\South\TX
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip AZ.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\AZ
Filename: "{app}\7za.exe"; Parameters: "e AZ.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\AZ
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip CO.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\CO
Filename: "{app}\7za.exe"; Parameters: "e CO.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\CO
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip NM.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\NM
Filename: "{app}\7za.exe"; Parameters: "e NM.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\NM
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip NV.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\NV
Filename: "{app}\7za.exe"; Parameters: "e NV.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\NV
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip UT.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\UT
Filename: "{app}\7za.exe"; Parameters: "e UT.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Southwest\UT
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip CA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\West\CA
Filename: "{app}\7za.exe"; Parameters: "e CA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\West\CA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip OR.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\West\OR
Filename: "{app}\7za.exe"; Parameters: "e OR.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\West\OR
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip WA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\West\WA
Filename: "{app}\7za.exe"; Parameters: "e WA.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\West\WA
Filename: "{app}\7za.exe"; Parameters: "e climate-US-2_0.zip HI.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Other\HI
Filename: "{app}\7za.exe"; Parameters: "e HI.zip"; WorkingDir: "{app}\tmy"; Components: Climate_Data\US\Other\HI

[UninstallDelete]
Type: files; Name: "{app}\tmy\climate-US-2_0.zip"
Type: filesandordirs; Name: "{app}\mingw64"
