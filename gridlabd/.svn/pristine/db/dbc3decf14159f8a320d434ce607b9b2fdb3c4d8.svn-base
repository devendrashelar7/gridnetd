...
public:
	...
	complex impedance1;				///< Secondary Series impedance (only used when you want to define each individual winding seperately
	complex impedance2;				///< Secondary Series impedance (only used when you want to define each individual winding seperately   
	complex shunt_impedance;		///< Shunt impedance - all values are summed and reflected back to the primary
	double no_load_loss;			///< Another method of specifying transformer impedances, defined as per unit power values (shunt)
	double full_load_loss;			///< Another method of specifying transformer impedances, defined as per unit power values (shunt and series)
