...
substation::substation(MODULE *mod) : node(mod)
{
	...
	if (oclass==NULL)
	{
		...
		if (gl_publish_variable(oclass,
			...
			PT_double, "distribution_energy[Wh]", PADDR(distribution_energy),PT_DESCRIPTION,"metered energy",
			PT_complex, "distribution_power[VA]", PADDR(distribution_power),PT_DESCRIPTION,"metered power",
			PT_double, "distribution_demand[W]", PADDR(distribution_demand),PT_DESCRIPTION,"metered demand (peak of power)",
			
			// added to record last voltage/current
			PT_complex, "distribution_voltage_A[V]", PADDR(distribution_voltage[0]),PT_DESCRIPTION,"measured voltage on phase A",
			PT_complex, "distribution_voltage_B[V]", PADDR(distribution_voltage[1]),PT_DESCRIPTION,"measured voltage on phase B",
			PT_complex, "distribution_voltage_C[V]", PADDR(distribution_voltage[2]),PT_DESCRIPTION,"measured voltage on phase C",
			PT_complex, "distribution_current_A[A]", PADDR(distribution_current[0]),PT_DESCRIPTION,"measured current on phase A",
			PT_complex, "distribution_current_B[A]", PADDR(distribution_current[1]),PT_DESCRIPTION,"measured current on phase B",
			PT_complex, "distribution_current_C[A]", PADDR(distribution_current[2]),PT_DESCRIPTION,"measured current on phase C",

			// Information on Network solver connection
			PT_double, "Network_Node_Base_Power[MVA]", PADDR(Network_Node_Base_Power),PT_DESCRIPTION,"base MVA for network node",
			PT_double, "Network_Node_Base_Voltage[V]", PADDR(Network_Node_Base_Voltage),PT_DESCRIPTION,"base Voltage for network node",
