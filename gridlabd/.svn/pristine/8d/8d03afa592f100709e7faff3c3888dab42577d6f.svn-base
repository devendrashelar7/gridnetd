...
Source: "..\..\..\third_party\i686-w64-mingw32-gcc-4.7.2-release-win32_rubenvb.7z"; DestDir: "{app}"; Flags: deleteafterinstall
...
begin
  ...
  Path := ExpandConstant('{app}\mingw32\bin');
  if RegQueryStringValue(RootKey, SubKey, 'PATH', Value) then
  begin
    if Pos(Uppercase(Path + ';'), Uppercase(Value + ';')) <> 0 then
      exit;
...
Filename: "{app}\7za.exe"; Parameters: "x i686-w64-mingw32-gcc-4.7.2-release-win32_rubenvb.7z"; WorkingDir: "{app}"; Components: Compilers
...
Type: filesandordirs; Name: "{app}\mingw32"
