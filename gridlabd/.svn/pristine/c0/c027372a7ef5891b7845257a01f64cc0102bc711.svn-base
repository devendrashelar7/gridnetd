	...
	if (oclass==NULL)
	{
		...
		if (gl_publish_variable(oclass,
			...
			PT_enumeration, "hvac_mode", PADDR(zone.hvac.mode),
				PT_KEYWORD, "HEAT", (enumeration)HC_HEAT,
				PT_KEYWORD, "AUX", (enumeration)HC_AUX,
				PT_KEYWORD, "COOL", (enumeration)HC_COOL,
				PT_KEYWORD, "ECON", (enumeration)HC_ECON,
				PT_KEYWORD, "VENT", (enumeration)HC_VENT,
				PT_KEYWORD, "OFF", (enumeration)HC_OFF,
...
{	
	...
	enumeration &mode = (zone.hvac.mode);
