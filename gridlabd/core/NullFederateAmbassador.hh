...
////////////////////////////////////
	...
	virtual void synchronizationPointRegistrationSucceeded(const char *label) // supplied C4)
			throw (RTI::FederateInternalError) {
	}

	virtual void synchronizationPointRegistrationFailed(const char *label) // supplied C4)
			throw (RTI::FederateInternalError) {
	}

	virtual void announceSynchronizationPoint(const char *label, // supplied C4
			const char *tag)   // supplied C4
					throw (RTI::FederateInternalError) {
	}

	virtual void federationSynchronized(const char *label) // supplied C4)
			throw (RTI::FederateInternalError) {
	}

	virtual void initiateFederateSave(const char *label) // supplied C4
	...
	virtual void requestFederationRestoreSucceeded(const char *label) // supplied C4
			throw (RTI::FederateInternalError) {
	}
	...
	virtual void initiateFederateRestore(const char *label,   // supplied C4
...
/////////////////////////////////////
	...
	virtual void stopRegistrationForObjectClass(RTI::ObjectClassHandle theClass) // supplied C1
...
////////////////////////////////
	...
	virtual void discoverObjectInstance(RTI::ObjectHandle theObject, // supplied C1
	...
	virtual void reflectAttributeValues(RTI::ObjectHandle theObject, // supplied C1
...
// 4.6
	virtual void receiveInteraction(RTI::InteractionClassHandle theInteraction, // supplied C1
	...
	virtual void removeObjectInstance(RTI::ObjectHandle theObject, // supplied C1
			const RTI::FedTime& theTime,   // supplied C4
			const char *theTag,    // supplied C4
			RTI::EventRetractionHandle theHandle)
					// supplied C1
	...
	virtual void attributesInScope(RTI::ObjectHandle theObject,   // supplied C1
	...
	virtual void attributesOutOfScope(RTI::ObjectHandle theObject, // supplied C1
			const RTI::AttributeHandleSet& theAttributes)
					// supplied C4
					throw (RTI::ObjectNotKnown, RTI::AttributeNotKnown,
					RTI::FederateInternalError) {
	...
	virtual void provideAttributeValueUpdate(RTI::ObjectHandle theObject, // supplied C1
			const RTI::AttributeHandleSet& theAttributes)
					// supplied C4
					throw (RTI::ObjectNotKnown, RTI::AttributeNotKnown,
	...
	virtual void turnUpdatesOnForObjectInstance(RTI::ObjectHandle theObject, // supplied C1
			const RTI::AttributeHandleSet& theAttributes)
					// supplied C4
	...
	virtual void turnUpdatesOffForObjectInstance(RTI::ObjectHandle theObject, // supplied C1
			const RTI::AttributeHandleSet& theAttributes)
					// supplied C4
					throw (RTI::ObjectNotKnown, RTI::AttributeNotOwned,
					RTI::FederateInternalError) {
...
///////////////////////////////////
	...
	virtual void attributeOwnershipUnavailable(RTI::ObjectHandle theObject, // supplied C1
			const RTI::AttributeHandleSet& theAttributes)
					// supplied C4
					throw (RTI::ObjectNotKnown, RTI::AttributeNotKnown,
	...
	virtual void requestAttributeOwnershipRelease(RTI::ObjectHandle theObject, // supplied C1
	...
	virtual void informAttributeOwnership(RTI::ObjectHandle theObject, // supplied C1
	...
	virtual void attributeIsNotOwned(RTI::ObjectHandle theObject, // supplied C1
	...
	virtual void attributeOwnedByRTI(RTI::ObjectHandle theObject, // supplied C1
			RTI::AttributeHandle theAttribute)
					// supplied C1
					throw (RTI::ObjectNotKnown, RTI::AttributeNotKnown,
					RTI::FederateInternalError) {
...
//////////////////////////////
	...
	virtual void requestRetraction(RTI::EventRetractionHandle theHandle) // supplied C1
			throw (RTI::EventNotKnown, RTI::FederateInternalError) {
	}
};

#else
typedef struct NullFederateAmbassador NullFederateAmbassador;
