...
DefaultSimulatorImpl::Run (void)
{
  ...
  printf("default-simulator-impl.cc : help me help me help me\n" );

  while (!m_events->IsEmpty () && !m_stop) 
    {
      //int sex = (int) m_currentTs;
      //printf("default-simulator-impl.cc : Scheduling one event at a time %llu\n" ,m_currentTs);
      ProcessOneEvent ();
    }
...
bool
SimulatorImpl::IsSimulationActive () 
{
  return false;  
}
