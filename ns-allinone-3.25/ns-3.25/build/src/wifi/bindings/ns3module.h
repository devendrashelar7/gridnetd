...
class PythonCallbackImpl3 : public ns3::CallbackImpl<void, ns3::Ptr<ns3::Packet>, double, bool, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>
{
public:
    PyObject *m_callback;
    ...
    void
    operator()(ns3::Ptr< ns3::Packet > arg1, double arg2, bool arg3)
    {
        PyGILState_STATE __py_gil_state;
        PyObject *py_retval;
        ...
        args = Py_BuildValue((char *) "(NdN)", py_Packet, arg2, PyBool_FromLong(arg3));
        py_retval = PyObject_CallObject(m_callback, args);
        if (py_retval == NULL) {
            Py_DECREF(args);
            if (PyEval_ThreadsInitialized())
