...
static PyMethodDef PyNs3TracedValue__Ns3LrWpanMacState_methods[] = {
    {(char *) "Set", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanMacState_Set, METH_KEYWORDS|METH_VARARGS, "Set(v)\n\ntype: v: ns3::LrWpanMacState &" },
    {(char *) "Disconnect", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanMacState_Disconnect, METH_KEYWORDS|METH_VARARGS, "Disconnect(cb, path)\n\ntype: cb: ns3::CallbackBase const &\ntype: path: std::string" },
    {(char *) "Get", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanMacState_Get, METH_NOARGS, "Get()\n\n" },
    {(char *) "ConnectWithoutContext", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanMacState_ConnectWithoutContext, METH_KEYWORDS|METH_VARARGS, "ConnectWithoutContext(cb)\n\ntype: cb: ns3::CallbackBase const &" },
    {(char *) "DisconnectWithoutContext", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanMacState_DisconnectWithoutContext, METH_KEYWORDS|METH_VARARGS, "DisconnectWithoutContext(cb)\n\ntype: cb: ns3::CallbackBase const &" },
    {(char *) "Connect", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanMacState_Connect, METH_KEYWORDS|METH_VARARGS, "Connect(cb, path)\n\ntype: cb: ns3::CallbackBase const &\ntype: path: std::string" },
...
PyTypeObject PyNs3TracedValue__Ns3LrWpanMacState_Type = {
    ...
    (PyBufferProcs*)NULL,  /* tp_as_buffer */
    Py_TPFLAGS_DEFAULT,                      /* tp_flags */
    "TracedValue__Ns3LrWpanMacState(o)\nTracedValue__Ns3LrWpanMacState(v)\nTracedValue__Ns3LrWpanMacState()",                        /* Documentation string */
    (traverseproc)NULL,     /* tp_traverse */
    (inquiry)NULL,             /* tp_clear */
...
static PyMethodDef PyNs3TracedValue__Ns3LrWpanPhyEnumeration_methods[] = {
    {(char *) "Set", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanPhyEnumeration_Set, METH_KEYWORDS|METH_VARARGS, "Set(v)\n\ntype: v: ns3::LrWpanPhyEnumeration &" },
    {(char *) "Disconnect", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanPhyEnumeration_Disconnect, METH_KEYWORDS|METH_VARARGS, "Disconnect(cb, path)\n\ntype: cb: ns3::CallbackBase const &\ntype: path: std::string" },
    {(char *) "Get", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanPhyEnumeration_Get, METH_NOARGS, "Get()\n\n" },
    {(char *) "ConnectWithoutContext", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanPhyEnumeration_ConnectWithoutContext, METH_KEYWORDS|METH_VARARGS, "ConnectWithoutContext(cb)\n\ntype: cb: ns3::CallbackBase const &" },
    {(char *) "DisconnectWithoutContext", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanPhyEnumeration_DisconnectWithoutContext, METH_KEYWORDS|METH_VARARGS, "DisconnectWithoutContext(cb)\n\ntype: cb: ns3::CallbackBase const &" },
    {(char *) "Connect", (PyCFunction) _wrap_PyNs3TracedValue__Ns3LrWpanPhyEnumeration_Connect, METH_KEYWORDS|METH_VARARGS, "Connect(cb, path)\n\ntype: cb: ns3::CallbackBase const &\ntype: path: std::string" },
...
PyTypeObject PyNs3TracedValue__Ns3LrWpanPhyEnumeration_Type = {
    ...
    (PyBufferProcs*)NULL,  /* tp_as_buffer */
    Py_TPFLAGS_DEFAULT,                      /* tp_flags */
    "TracedValue__Ns3LrWpanPhyEnumeration(o)\nTracedValue__Ns3LrWpanPhyEnumeration(v)\nTracedValue__Ns3LrWpanPhyEnumeration()",                        /* Documentation string */
    (traverseproc)NULL,     /* tp_traverse */
    (inquiry)NULL,             /* tp_clear */
...
static PyMethodDef PyNs3SimpleRefCount__Ns3LrWpanInterferenceHelper_Ns3Empty_Ns3DefaultDeleter__lt__ns3LrWpanInterferenceHelper__gt___methods[] = {
    {(char *) "Cleanup", (PyCFunction) _wrap_PyNs3SimpleRefCount__Ns3LrWpanInterferenceHelper_Ns3Empty_Ns3DefaultDeleter__lt__ns3LrWpanInterferenceHelper__gt___Cleanup, METH_NOARGS|METH_STATIC, "Cleanup()\n\n" },
...
_wrap_PyNs3LrWpanNetDevice_AddLinkChangeCallback(PyNs3LrWpanNetDevice *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyObject *callback;
    ns3::Ptr<PythonCallbackImpl9> callback_cb_impl;
    ...
    callback_cb_impl = ns3::Create<PythonCallbackImpl9> (callback);
